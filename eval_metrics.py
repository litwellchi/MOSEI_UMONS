...
def eval_mosei_senti(results, truths, exclude_zero=False):
    ...
    test_preds_a7 = np.clip(test_preds, a_min=0., a_max=6.)
    test_truth_a7 = np.clip(test_truth, a_min=0., a_max=6.)
    test_preds_a5 = np.clip(test_preds, a_min=2., a_max=4.)
    test_truth_a5 = np.clip(test_truth, a_min=4., a_max=4.)
    ...
    binary_truth = (test_truth[non_zeros] > 3)
